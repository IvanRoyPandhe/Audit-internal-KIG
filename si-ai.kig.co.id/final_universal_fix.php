<?php
$files = glob('*.php');
$excludeFiles = ['final_universal_fix.php', 'login.php', 'logout.php', 'login_process.php', 'config.php', 'sidebar.php', 'profile_modals.php'];
...
foreach ($files as $file) {
    if (!in_array($file, $excludeFiles)) {
        ...
        // Fix dropdown links that don't have modal attributes
        ...
        // Add profile_modals.php include if missing
