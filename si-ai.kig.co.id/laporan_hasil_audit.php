...
<head>
  ...
  <title>Laporan Hasil Audit - SI AI KIG</title>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title fw-semibold mb-4">Laporan Hasil Audit</h5>
                  <p>Halaman untuk mengelola laporan hasil audit internal.</p>
                </div>
              </div>
            </div>
          </div>
